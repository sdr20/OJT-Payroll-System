...
export const recordPositionHistory = async (req, res) => {
    try {
        ...
        // Assuming employeeId is a MongoDB ObjectId now (not an integer)
...
export const getPositionHistory = async (req, res) => {
    try {
        ...
        const employee = await Employee.findById(employeeId).select('firstName lastName positionHistory position salary');
