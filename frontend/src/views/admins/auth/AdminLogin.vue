<template>
  <div class="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 flex items-center justify-center p-4">
    <div class="w-full max-w-md">
      <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl p-8 space-y-6 animate-fadeIn">
          ...
          <div class="space-y-1">
            ...
            <div class="relative">
              ...
              <input v-model="email" type="email" id="email" name="email"
                ...
                :class="{ 'border-red-300': loginError, 'border-gray-300': !loginError }"
  ...
  methods: {
    async login() {
      ...
      try {
        ...
        this.authStore.login(admin, token);
        this.$router.push('/admin');
      } catch (error) {
