            ...
            <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl p-8 space-y-6">
                ...
                <form @submit.prevent="login" class="space-y-4">
                    <div class="space-y-1">
                        ...
                        <input v-model="username" type="text" id="username" class="block w-full p-2 border border-gray-300 rounded-lg"
                    ...
                    <div class="flex items-center justify-end">
                        <router-link :to="{ name: 'LoginSelection' }" class="text-sm text-indigo-600 hover:text-indigo-700">
